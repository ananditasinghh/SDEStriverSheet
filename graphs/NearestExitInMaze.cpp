    ...
    int find(vector<vector<char>> &maze, int st1, int st2) {
        ...
        while (!q.empty()) {
            ...
            while (s--) {
                ...
                // check if person reach to any of the boundary and also check
                // if person making move to reach boundary i.e person doesn't 
                //staying at boundary initially
                ...
                for (int i = 0; i < 4; ++i) {
                    ...
                    // if the new position is not visited or it 
                    //should be a valid position also it's not a wall then make moves
